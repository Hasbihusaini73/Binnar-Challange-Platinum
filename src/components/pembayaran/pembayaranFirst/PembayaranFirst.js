            ...
            <div className="sectionHero">
                <div className="pilihanBank">
                    ...
                    <div className="banks">
                        {bank.map((item, index) => {
                            return (
                                <button className="logoBank" key={index} onClick={
                                    () => handleBank(index)
                                }>
                                    <p className="logo">
                                        {item.value}
                                    </p>
                                    <p className="namaLogo">
                                        {item.value} Transfer
                                    </p>
                                    <p className="logoCeklis">
                                    {item.status ? <LogoCeklis /> : ""}
                                    </p>
                ...
                <div className="endHero">
                  ...
                  <div className="keterangan">
                    ...
                    {statusDetail && <div className="detailEndHero" >
                        <div className="itemDetail harga">
                            <p className="judulItem">Harga</p>
                            <div className="containerItem">
                                <li>Sewa Mobil Rp.{data.mobil.price.toLocaleString("ID-id")} x{data.durasi} Hari</li>
