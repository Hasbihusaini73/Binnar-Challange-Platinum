    ...
    return (
        <div className={"headerPembayaran " +( props.second ? " second ": " ")}>
            ...
            <path fillRule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8z"/>
                ...
                <p className="judul">{judul.judul} {judul.text && "transfer"} </p>
            ...
            <div className="endHeader">
                ...
                <p className="process secondProcess">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" className={posisi === "dua" ? "blue" : ""} height="32" viewBox="0 0 24 24"><path fill="currentColor" d="M19.5 14.5q-.775 0-1.4-.425q-.625-.425-.9-1.075H3q-.425 0-.712-.288Q2 12.425 2 12t.288-.713Q2.575 11 3 11h14.2q.275-.65.9-1.075q.625-.425 1.4-.425q1.05 0 1.775.725Q22 10.95 22 12q0 1.05-.725 1.775q-.725.725-1.775.725Z"/></svg>
                    {/* end setrip */}
                ...
                <p className="process endProcess">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"><path fill="currentColor" d="M19.5 14.5q-.775 0-1.4-.425q-.625-.425-.9-1.075H3q-.425 0-.712-.288Q2 12.425 2 12t.288-.713Q2.575 11 3 11h14.2q.275-.65.9-1.075q.625-.425 1.4-.425q1.05 0 1.775.725Q22 10.95 22 12q0 1.05-.725 1.775q-.725.725-1.775.725Z"/></svg>
                    {/* end setrip */}
